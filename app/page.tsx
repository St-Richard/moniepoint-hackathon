...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      ...
      {CardData && <div className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
      ...
      <button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 transition-colors duration-300" >Refresh the Data</button>
      </main>
    </div>
  );
}
